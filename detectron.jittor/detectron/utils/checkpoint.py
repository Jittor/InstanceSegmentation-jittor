...
from detectron.utils.model_zoo import cache_url
from detectron.utils.deformable_model_loading import load_deformable_vovnet
...
class Checkpointer(object):
    ...
    def load(self, f=None, use_latest=True):
        ...
        #    self.optimizer.load_parameters(checkpoint.pop("optimizer"))
