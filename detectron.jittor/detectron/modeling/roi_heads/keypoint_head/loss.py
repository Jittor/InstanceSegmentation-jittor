...
from detectron.modeling.balanced_positive_negative_sampler import (
...
from detectron.structures.keypoint import keypoints_to_heat_map
...
class KeypointRCNNLossComputation(object):
    ...
    def __call__(self, proposals, keypoint_logits):
        ...
        keypoint_loss = nn.cross_entropy_loss(keypoint_logits[valid], keypoint_targets[valid])
