...
from detectron.modeling.make_layers import conv_with_kaiming_uniform
...
def build_hrnet_fpn_backbone(cfg):
    ...
    if cfg.MODEL.BACKBONE.CONV_BODY == "HRNET-W18":
        ...
        width = 40
    elif cfg.MODEL.BACKBONE.CONV_BODY == "HRNET-W48":
        width = 48
    else:
    ...
    hrnet.BatchNorm2d = nn.SyncBatchNorm if cfg.MODEL.USE_SYNCBN else nn.BatchNorm
