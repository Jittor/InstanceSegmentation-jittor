...
def prep_display(dets_out, img, h, w, undo_transform=True, class_color=False, mask_alpha=0.45, fps_str=''):
    ...
    if args.display_masks and cfg.eval_mask_branch and num_dets_to_consider > 0:
        ...
        masks_color = masks.repeat(1, 1, 1, 3) * colors.repeat(1,masks.shape[1],masks.shape[2],1) * mask_alpha
...
def evalimage(net:Yolact, path:str, save_path:str='result.jpg'):
    frame = jt.array(cv2.imread(path)).float()
